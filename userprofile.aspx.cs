    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@full_name", TextBox20.Text.Trim());
                cmd.Parameters.AddWithValue("@dob", TextBox21.Text.Trim());
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                TextBox20.Text = dt.Rows[0]["full_name"].ToString();
                TextBox21.Text = dt.Rows[0]["dob"].ToString();
